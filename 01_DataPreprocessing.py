'''
1. This file just combine all csv files to one file named as "merged_data.csv".
   Why need to do that because just want to combine data for train and test with machine learning

2. Synchronize data left and right
'''
...
df_l = df_l.reset_index(drop=True) #reset index to the default 0,1,2 ect indexes
